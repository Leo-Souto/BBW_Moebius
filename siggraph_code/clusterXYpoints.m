...
%
%% Author
%  Yann Marcon (Yann.Marcon@awi.de) -- Original Author
%  Some modifications added -- By other author
%
%
%% Code
function [clustersCentroids,clustersGeoMedians,clustersXY, clustersInd] = clusterXYpoints(inputfile,maxdist,minClusterSize,method,mergeflag)
...
pairs = []; % column 1 = point1, column2 = point2
kmax = size(XY,1);
for k = 2:kmax
    pairs = [ pairs ; [ (k:kmax)' , (k-1) * ones(kmax-(k-1),1) ] ];
end
