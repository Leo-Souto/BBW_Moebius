...
handles.cages_plot = {};
handles.cage_edge_list = morehandles.cage_edge_list;
handles.handle_to_edge_list = morehandles.handle_to_edge_list;
        ...
        if ~isempty(solution)
            ...
            for i = 1:length(solution_index)
                for j = 1:size(solution_index{i},1)
                    ...
                    if isequal(handles.all_handles{ind_1}.type,'Point')
